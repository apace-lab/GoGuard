...
import (
	...
	"github.com/bozhen-liu/gopa/internal/lsp/baz"
	_ "github.com/bozhen-liu/gopa/internal/lsp/signature" // provide type information for unimported completions in the other file
)
