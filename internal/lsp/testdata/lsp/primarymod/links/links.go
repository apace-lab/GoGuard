...
import (
	...
	"github.com/bozhen-liu/gopa/internal/lsp/testdata/lsp/primarymod/foo" //@link(`github.com/april1989/origin-go-tools/internal/lsp/foo`,`https://pkg.go.dev/github.com/april1989/origin-go-tools/internal/lsp/foo`)
